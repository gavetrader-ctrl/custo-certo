...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-wash font-sans text-ink antialiased">
      <div className="pointer-events-none fixed -left-32 top-[-14%] h-[520px] w-[520px] rounded-full bg-brand/15 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none fixed right-[-10%] top-1/2 h-[480px] w-[480px] rounded-full bg-navy/10 blur-3xl" aria-hidden="true" />
      ...
      <header className="sticky top-0 z-30 border-b border-line/70 bg-card/60 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-6 py-3">
          <div className="flex items-center gap-3">
            <div className="grid size-9 place-items-center rounded-lg bg-navy text-[13px] font-bold text-navy-foreground">OF</div>
      ...
      <main className="relative mx-auto max-w-[1440px] px-6 py-6">
        <div className="animate-rise mb-5 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            />
            <p className="mt-1 text-sm text-muted-ink">Composição de custos, encargos, BDI e impostos</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[620px] border-collapse text-[13px]">
                ...
                <tbody className="font-mono">
                  {itens.map((item) => (
                    <tr key={item.id} className="border-b border-line/60 transition-colors hover:bg-brand-soft/40">
          ...
          <aside className="animate-rise self-start rounded-2xl border border-line/80 bg-card/70 p-5 backdrop-blur-xl lg:sticky lg:top-[76px]">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded-full bg-brand-soft px-2 py-0.5 font-mono text-[10px] font-medium text-brand">AO VIVO</span>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="mt-3 rounded-xl border border-line/70 bg-card/50 p-3">
                <div className="mb-2 flex items-center justify-between">
                  <span className="text-[11px] font-semibold uppercase tracking-wider text-navy">BDI</span>
                  <span className="font-mono text-[12px] font-semibold text-ink">{pct(r.bdiPercent)}</span>
                </div>
              ...
              <div className="mt-3 rounded-xl border border-line/70 bg-card/50 p-3">
                <div className="mb-2 flex items-center justify-between">
                  <span className="text-[11px] font-semibold uppercase tracking-wider text-navy">Impostos</span>
                  <button
                    onClick={() =>
                      setOrc((o) => ({
                        ...o,
                        percentuais: {
                          ...o.percentuais,
                          impostos: [...o.percentuais.impostos, { id: novoId(), nome: "Novo imposto", aliquota: 0 }],
                        },
                      }))
                    }
                ...
                <div className="mt-2.5 flex items-center justify-between border-t border-line/60 pt-2">
                  <span className="text-[12px] text-muted-ink">Impostos ({pct(r.impostoPercent)})</span>
            ...
            <div className="mt-4 rounded-xl bg-navy p-4 text-navy-foreground">
              <p className="text-[11px] uppercase tracking-wider text-navy-foreground/60">Preço final de venda</p>
              <p className="mt-1 font-mono text-[26px] font-semibold tracking-tight">{brl(r.precoFinal)}</p>
